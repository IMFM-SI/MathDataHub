...
from mdh.utils import ModelWithMetadata, uuid4
...
class Provenance(ModelWithMetadata):
    ...
    time: datetime = models.DateTimeField(
        auto_now_add=True, help_text="Time at which this provenance was created"
    )
    predecessor: Optional[Provenance] = models.ForeignKey(
        "self",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        help_text="Previous provenance",
    )
