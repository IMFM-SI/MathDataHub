...
class ABCollectionWithViewTest(TestCase):
    ...
    def setUp(self) -> None:
        ...
        management.call_command(
            "collection_view", self.collection.slug, "--enable", "--sync"
        )
    ...
    def test_sql_uses_view(self) -> None:
        ...
        self.assertEqual(
            queryset.query.sql,
            """SELECT id, "property_value_basis_0", "property_cid_basis", "property_value_k_0", "property_cid_k", "property_value_n_0", "property_cid_n", "property_value_S_0", "property_cid_S", "property_value_R_0", "property_cid_R" FROM mdh_view_ab""",
        )
